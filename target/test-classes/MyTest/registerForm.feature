...
#
#  Scenario Outline: Test Mobile Phone field
#    Given the '<mobileField>' is filled with '<mobileParameter>' in register form
#    And the Password Field is filled with "validPassword" in register form
#    And the Zip Code Field is filled with "00000" in register form
#    When the Register button is clicked
#    Then the '<msg>' error message is shown in register form
#    Examples:
#      | mobileField         | mobileParameter          |msg                                                 |
#      | phone_mobile        |                          |You must register at least one phone number.        |
#      | phone_mobile        |  phoneNumber             |phone_mobile is invalid.                            |
